...
interface ICEvaluationFormProps {
  data: { questions: Question[] } | null;
  onChange: (data: { questions: Question[] }) => void;
}

export function ICEvaluationForm({ data, onChange }: ICEvaluationFormProps) {
